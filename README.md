...
- Fetch and render cat images in card format
- Handle loading state, empty state, and error state
- Pagination for fetching more images (Medium difficulty)
- Infinite scroll for automatically loading more images as the user scrolls down
## Available Scripts
